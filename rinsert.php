			...
			<div class="col-md-4 col-sm-6">
				<div class="single-how-works">
					...
					<select name="type" required>
						<option value ="平時預借(30天內)">平時預借(30天內)</option>
					</select>
					<br>
					<label for="bookdate">日期：</label><br>
					<input type="date" max='<? echo $ndate ?>' min='<? echo $date ?>' name="sdate" value="<? echo $sdate ?>" placeholder="2018-10-27" required><br>
					至<br>
					<input type="date" max='<? echo $ndate ?>' min='<? echo $date ?>' name="edate" value="<? echo $edate ?>" placeholder="2018-10-27" required>
				</div>
			</div>
