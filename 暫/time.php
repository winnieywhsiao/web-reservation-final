			...
			<div class="card mb-3">
				...
				<div class="table-responsive">
					<center>
							...
							<input type="date" id="bookdate" placeholder="2018-10-27">&nbsp;~&nbsp;<input type="date" id="bookdate" placeholder="2018-10-27">
							<button type="submit" class="btn btn-primary" name="addenter">確定</button>
					</center>
